...
def process_callback_job(pc_prefix:str, queued_json_payload:Dict[str,Any], redis_connection):
    ...
    if unzip_dir is None:
        ...
        AppSettings.logger.info(f"Uploading build log to {AppSettings.cdn_bucket_name}/{url_part2}/pdf_build_log.json and {AppSettings.door43_bucket_name}/{url_part2}/pdf_build_log.json …")
